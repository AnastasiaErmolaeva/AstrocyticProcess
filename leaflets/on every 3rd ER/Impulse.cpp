...
void Impulse::init(const FP & amplitudeIn, const FP & durationIn, const FP & startTimeIn, const FP& impulseFreqIn, const int& impulsesQuantityIn, const FrequencyType& freqTypeIn, const AmplitudeType& ampTypeIn, const FP& minAmpIn, const FP& maxAmpIn, const FP& timeStepIn, const int& seeddd)
{
