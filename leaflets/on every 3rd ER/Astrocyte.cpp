...
void Astrocyte::init(const vector<Cell*>& tailNet_in)
{
	...
	for (int iPart = 0; iPart < nAstroParts; ++iPart)
	{
		...
		astroParts[iPart].impulseComp2.init(impulseAmplitudeComp, impulseDurationComp, impulseStartTimeComp, impulseFreqComp2, impulsesQuantityComp, FrequencyType(freqTypeIntComp), AmplitudeType(ampTypeIntComp), impMinAmpComp, impMaxAmpComp, timeStep, seed + nAstroParts + iPart);
	}
...
{
	if ((iPart == 2) || (iPart == 5) || (iPart == 8) || (iPart == 11) || (iPart == 14) || (iPart == 17) || (iPart == 20) || (iPart == 23) || (iPart == 26) || (iPart == 29) || (iPart == 32) || (iPart == 35) || (iPart == 38) || (iPart == 41) || (iPart == 44) || (iPart == 47))
	{
		param1[iPart] = 0.;
		param2[iPart] = 1.;
	}
